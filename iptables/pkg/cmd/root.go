...
var (
	...
	dnsCaptureByAgent = env.RegisterBoolVar("IDEFAV_META_DNS_CAPTURE", false,
...
var rootCmd = &cobra.Command{
	Use:    "idefav-iptables",
	Short:  "Set up iptables rules for Idefav Sidecar",
	Long:   "idefav-iptables is responsible for setting up port forwarding for Idefav Sidecar.",
	PreRun: bindFlags,
